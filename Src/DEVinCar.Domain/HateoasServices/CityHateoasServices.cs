...
{
    public class CityHateoasServices: IHateoasServices<CityDTO>
    {
        public List<HateoasDTO> GetHateoas(CityDTO entity, string baseURI, int id)
        {
        ...
        public List<HateoasDTO> GetHateoasForAll(CityDTO entity, string baseURI, int take, int skip, int ultimo)
        {
            var hateoas = new List<HateoasDTO>() {
                new HateoasDTO(){
                    Rel = "self",
