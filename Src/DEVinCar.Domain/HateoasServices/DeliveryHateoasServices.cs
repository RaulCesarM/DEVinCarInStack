...
{
    public class DeliveryHateoasServices: IHateoasServices<DeliveryDTO>
    {
        public List<HateoasDTO> GetHateoas(DeliveryDTO entity, string baseURI, int id)
        {
        ...
        public List<HateoasDTO> GetHateoasForAll(DeliveryDTO entity, string baseURI, int take, int skip, int ultimo)
        {
            var hateoas = new List<HateoasDTO>() {
                new HateoasDTO(){
                    Rel = "self",
